 ...
 * @Version 1.0
 */
public class ReflectStudent1 {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        String cName = "august/bao0829/demo01/Student1.java";
        ////解析获取未知类型的类文件
        ...
        Object o = c1.newInstance(001, "小明");
        ...
        System.out.println("学生对象1的学号为： " + id);
        System.out.println("学生对象1的姓名为： " + name);
